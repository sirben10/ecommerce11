                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            ...
                            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle" >
                                ...
                                <h2 class="h3 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5"  style="inline-size: 400px;">
                                    {{ $slide->subtitle }}</h2>
                                <h2 class="h2 fw-bold animate animate_fade animate_btt animate_delay-5" style="inline-size: 400px;">
