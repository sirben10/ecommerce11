                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            ...
                            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                                <img loading="lazy" src="{{ asset('uploads/slides') }}/{{ $slide->image }}" width="642"
                                    height="800" alt=" {{ $slide->title }}"
                                    class="slideshow-character__img animate animate_fade animate_btt animate_delay-9 h-auto" />
                            ...
                            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                                ...
                                <h2 class="h3 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5"
                                    style="inline-size: 400px;">
                                    {{ $slide->subtitle }}</h2>
                                <h2 class="h2 fw-bold animate animate_fade animate_btt animate_delay-5"
                                    style="inline-size: 400px;">
                                    {{ ucwords($slide->title) }}</h2>
                                <a href=" {{ $slide->link }}"
        ...
        <div class="container mw-1620 bg-white border-radius-10">
                            ...
                            @foreach ($categories as $category)
                                <div class="swiper-slide">
                                    ...
                                    <div class="text-center">
                                        <a href="{{ route('shop.index', parameters: ['categories' => $category->id]) }}"
                                            class="menu-link fw-medium">{{ $category->name }}<br />Tops</a>
                                    </div>
                                </div>
                            @endforeach
                        </div><!-- /.swiper-wrapper -->
                                                ...
                                                <div class="product-card__price d-flex">
                                                    <span class="money price text-secondary">
                                                        @if ($sproduct->sale_price)
                                                            <s>${{ number_format($sproduct->regular_price, 2) }}</s>
                                                            ${{ number_format($sproduct->sale_price, 2) }}
                                                        @else
            ...
            <section class="products-grid container">
                                ...
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', ['product_slug' => $fproduct->slug]) }}">
                                        <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $fproduct->image }}"
                                            width="330" height="400" alt="Cr{{ $fproduct->name }}"
                                            class="pc__img">
                                    </a>
                                </div>
                ...
                <div class="text-center mt-2">
                    <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium" href="{{ route('shop.index') }}">See
                        All</a>
                </div>
            </section>
        </div>
